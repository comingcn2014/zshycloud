package com.zshy.uaa.controller;
...
import com.zshy.core.common.util.SecurityUtil;
...
import com.zshy.system.feign.ISysRolePermissionProvider;
import com.zshy.system.feign.ISysUserProvider;
import com.zshy.uaa.config.SocialConfig;
import com.zshy.uaa.enums.LoginType;
import com.zshy.uaa.service.ValidateService;
...
public class AuthController {
    ...
    public Result<?> getUser(HttpServletRequest request) {
        ...
        redisService.set(Oauth2Constant.ZSHY_PERMISSION_PREFIX + loginUser.getAccount()
    ...
    public Map<String, String> loginType() {
        ...
        return oauthList.stream().collect(Collectors.toMap(oauth -> oauth.toLowerCase() + "登录", oauth -> "http://localhost:10001/zshy-uaa/auth/login/" + oauth.toLowerCase()));
    }
