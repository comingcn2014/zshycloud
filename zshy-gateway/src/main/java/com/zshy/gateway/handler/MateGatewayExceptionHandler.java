...
@Slf4j
public class ZshyGatewayExceptionHandler extends DefaultErrorWebExceptionHandler {

    public ZshyGatewayExceptionHandler(ErrorAttributes errorAttributes, ResourceProperties resourceProperties,
