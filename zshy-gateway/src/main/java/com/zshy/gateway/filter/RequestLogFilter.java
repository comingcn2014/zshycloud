...
public class RequestLogFilter implements GlobalFilter, Ordered {
	...
	public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
		...
		String traceId = exchange.getRequest().getHeaders().getFirst(ZshyConstant.ZSHY_TRACE_ID);
		// 构建成一条长 日志，避免并发下日志错乱
		StringBuilder beforeReqLog = new StringBuilder(300);
		// 日志参数
		List<Object> beforeReqArgs = new ArrayList<>();
		beforeReqLog.append("\n\n================ Zshy Gateway Request Start  ================\n");
		// 打印路由
		beforeReqLog.append("===> {}: {}\n");
		// 参数
		...
		beforeReqLog.append("================ Zshy Gateway Request End =================\n");
		// 打印执行时间
		...
		return chain.filter(exchange).then(Mono.fromRunnable(() -> {
			...
			responseLog.append("\n\n================ Zshy Gateway Response Start  ================\n");
			// 打印路由 200 get: /zshy*/xxx/xxx
			responseLog.append("<=== {} {}: {}: {}\n");
			// 参数
			...
			responseLog.append("================  Zshy Gateway Response End  =================\n");
			// 打印执行时间
