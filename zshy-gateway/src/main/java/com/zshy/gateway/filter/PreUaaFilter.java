...
import com.zshy.core.common.util.TokenUtil;
...
public class PreUaaFilter implements GlobalFilter, Ordered {
	...
	private final ZshyApiProperties mateApiProperties;
	 ...
	 */
	public static final String PATH_PREFIX = "/zshy";
	...
	private Mono<Void> unauthorized(ServerHttpResponse resp, String msg) {
		return ResponseUtil.webFluxResponseWriter(resp, ZshyConstant.JSON_UTF8, HttpStatus.UNAUTHORIZED, msg); }

	@Override
	public int getOrder() {
		return ZshyConstant.ZSHY_UAA_FILTER_ORDER;
	}
