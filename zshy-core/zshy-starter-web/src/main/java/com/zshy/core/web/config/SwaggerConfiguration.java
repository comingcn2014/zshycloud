...
import com.zshy.core.web.props.ZshySwaggerProperties;
...
@EnableConfigurationProperties(ZshySwaggerProperties.class)
@PropertySource(factory = YamlPropertySourceFactory.class, value = "classpath:zshy-swagger.yml")
public class SwaggerConfiguration implements WebMvcConfigurer {

	private final ZshySwaggerProperties swaggerProperties;
	...
	private ApiInfo groupApiInfo() {
		return new ApiInfoBuilder()
				...
				.version(ZshyConstant.ZSHY_APP_VERSION)
				.build();
	}
	...
	private List<ApiKey> securitySchemes() {
		...
		apiKeyList.add(new ApiKey("Zshy-Auth", "Zshy-Auth", "header"));
		return apiKeyList;
	}
