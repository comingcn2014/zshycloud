package com.zshy.core.auth.aspect;
...
public class PreAuthAspect {
	...
	@Around("@annotation(com.zshy.core.auth.annotation.PreAuth)")
	...
	public boolean hasPerm(String permission) {
		...
		Map<String, Object> data = (Map<String, Object>) redisService.get(Oauth2Constant.ZSHY_PERMISSION_PREFIX
