...
//import com.zshy.core.feign.fallback.ZshyFallbackFactory;
//
///**
// * 添加 zshy 默认的 fallbackFactory L.cm 2019.01.19
// *
// * @author L.cm
// * @author Spencer Gibb
// * @author Erik Kringen
...
//public class ZshyHystrixTargeter implements Targeter {
//    @Override
...
//        }
//        // zshy 默认的 fallbackFactory
//        ZshyFallbackFactory<T> mateFallbackFactory = new ZshyFallbackFactory<>(target);
