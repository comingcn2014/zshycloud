package com.zshy.core.log.aspect;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.zshy.core.common.util.*;
import com.zshy.core.log.annotation.Log;
import com.zshy.core.log.event.LogEvent;
...
public class LogAspect {
    ...
    @Pointcut("@annotation(com.zshy.core.log.annotation.Log)")
    ...
    public Object recordLog(ProceedingJoinPoint point) throws Throwable {
        ...
        .setTraceId(request.getHeader(ZshyConstant.ZSHY_TRACE_ID))
