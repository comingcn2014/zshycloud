package com.zshy.core.log.util;
...
public class TrackUtil {
     ...
     * 例子1：2020-07-27 23:37:23|zshy-uaa|1|user-login|ip=xxx.xxx.xx&userName=张三&userType=后台管理员
     * 例子2：2020-07-27 23:37:23|zshy-system|c0a895e114526786450161001d1ed9|file-upload|fileName=xxx&filePath=xxx
     *
     * @param id      对象id
     * @param type    类型
     * @param message 对象属性
