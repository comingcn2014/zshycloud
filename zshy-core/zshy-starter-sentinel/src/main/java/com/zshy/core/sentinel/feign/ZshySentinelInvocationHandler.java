 ...
 */
@Slf4j
public class ZshySentinelInvocationHandler implements InvocationHandler {
	...
	ZshySentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			ZshySentinelInvocationHandler other = (ZshySentinelInvocationHandler) obj;
