...
public class Oauth2Constant {
	...
	public static final String SIGN_KEY = "ZSHY";

	public static final String CAPTCHA_KEY = "zshy.captcha.";

	public static final String SMS_CODE_KEY = "zshy.sms.code.";
	...
	public static final String HEADER_TOKEN = "Zshy-Auth";
	 ...
	 * 权限标识前缀
	 */
	public static final String ZSHY_PERMISSION_PREFIX = "zshy.permission.";

	/**
	 * 字段描述开始：用户ID
	 */
	public static final String ZSHY_USER_ID = "userId";

	/**
	 * 用户名
	 */
	public static final String ZSHY_USER_NAME = "userName";

	/**
	 * 用户头像
	 */
	public static final String ZSHY_AVATAR = "avatar";

	/**
	 * 用户权限ID
	 */
	public static final String ZSHY_ROLE_ID = "roleId";

	/**
	 * 用户类型
	 */
	public static final String ZSHY_TYPE = "type";

	/**
	 * 租户ID
	 */
	public static final String ZSHY_TENANT_ID = "tenantId";
