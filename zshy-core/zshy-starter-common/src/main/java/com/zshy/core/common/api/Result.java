...
public class Result<T> implements Serializable {
	...
	public static <T> Result<T> data(T data) {
		return data(data, ZshyConstant.DEFAULT_SUCCESS_MESSAGE);
	}
	...
	public static <T> Result<T> data(int code, T data, String msg) {
		return new Result<>(code, data, data == null ? ZshyConstant.DEFAULT_NULL_MESSAGE : msg);
	}
	...
	public static <T> Result<T> condition(boolean flag) {
		return flag ? success(ZshyConstant.DEFAULT_SUCCESS_MESSAGE) : fail(ZshyConstant.DEFAULT_FAIL_MESSAGE);
	}
}
