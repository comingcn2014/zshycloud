...
import com.zshy.core.common.context.UserContext;
...
public class SecurityUtil {
	...
	public static LoginUser getUsername(HttpServletRequest request) {
		...
		loginUser.setUserId(String.valueOf(claims.get(Oauth2Constant.ZSHY_USER_ID)));
		loginUser.setAccount((String) claims.get(Oauth2Constant.ZSHY_USER_NAME));
		loginUser.setRoleId(String.valueOf(claims.get(Oauth2Constant.ZSHY_ROLE_ID)));
		loginUser.setTenantId(String.valueOf(claims.get(Oauth2Constant.ZSHY_TENANT_ID)));
		loginUser.setType(NumberUtil.stoi(String.valueOf(claims.get(Oauth2Constant.ZSHY_TYPE))));
