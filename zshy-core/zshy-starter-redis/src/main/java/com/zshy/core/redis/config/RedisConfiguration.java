package com.zshy.core.redis.config;
...
import com.zshy.core.redis.props.ZshyRedisProperties;
import com.zshy.core.redis.core.RedisService;
import com.zshy.core.redis.util.RedisLockUtil;
 ...
 */
@Configuration
@EnableConfigurationProperties(ZshyRedisProperties.class)
@ConditionalOnProperty(value = ZshyRedisProperties.PREFIX + ".enabled", havingValue = "true", matchIfMissing = true)
