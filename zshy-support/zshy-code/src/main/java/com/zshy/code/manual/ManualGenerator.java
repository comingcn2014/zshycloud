...
/**
 * ZshyCloud 手动代码生成器，基于 Mybatis Plus文档实现
...
public class ManualGenerator {
	...
	public static void main(String[] args) {
        ...
        */
		...
		strategy.setSuperEntityClass("com.zshy.core.database.entity.BaseEntity");
		strategy.setEntityLombokModel(true);
		strategy.setRestControllerStyle(true);
		// 公共父类
		strategy.setSuperControllerClass("com.zshy.core.web.controller.BaseController");
		// 写于父类中的公共字段
